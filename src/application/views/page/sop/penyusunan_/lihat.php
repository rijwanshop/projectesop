<?php if($this->uri->segment(3) != ''){
	...
	$link = ($row['sop_update_file'] == '' ? ''.base_url().'sop/penyusunan_sop/print/'.$row['sop_alias'].'' : ''.base_url().'sop/pdf_sop/'.$row['sop_alias'].'');
			  ...
			  <div class="panel">
				<div class="panel-heading">
				  <div style="float:right; padding:10px">
					<a type="button" class="btn btn-success" href="<?=$link?>" target="_blank">
						<i class="fa fa-print"></i> Print
					</a>
				  </div>
				  <div style="float:right; padding:10px">
					<a type="button" class="btn btn-primary" href="<?=base_url()?>sop/penyusunan_sop/doc/<?=$alias?>/<?=$nama_sop?>" target="_blank">
