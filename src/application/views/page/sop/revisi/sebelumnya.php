<?php if($this->uri->segment(3) != ''){
	...
	$Arr = array();
	$t = 0;
	$q = 'SELECT r.revisi_id,r.sop_alias,s.* FROM revisi r left join sop_revisi s on r.sop_alias=s.sop_alias where r.revisi_id="'.$this->uri->segment(5).'" and r.sop_alias="'.$this->uri->segment(4).'"';
	$sop = $this->Sop_m->query_manual($q);
	if($sop->num_rows() > 0){
