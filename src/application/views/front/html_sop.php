<?php
				...
				$link = ($row['sop_update_file'] == '' ? ''.base_url().'pdf/index.php?alias='.md5($row['sop_alias']).'' : ''.base_url().'sop/pdf_sop/'.$row['sop_alias'].'');
...
<body>
						...
						<style>table { border-collapse: collapse; }.TableKeg{line-height:11px;} .TableKeg th{text-align:center}</style>
									...
									<td width="50%" align="center">
										...
										<div style="border-bottom:1px solid #000; text-align:left; margin-left:-2px; margin-right:-2px; padding:2px 0px;">
											...
											<div style="float:left; width:450px"><?=$disahkan_jabatan?> <br><br>
												...
												<?=$disahkan_nama?> <br>NIP <?=$disahkan_nip?>
											</div>
											<div style="clear:both"></div>
										</div>
