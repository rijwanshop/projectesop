    ...
    <div class="page-content">
      <div class="page-brand-info">
        <div class="brand">
          ...
          <h2 class="brand-text font-size-40">Sistem e-SOP Kemensetneg</h2>
        </div>
      ...
      <div class="page-login-main animation-slide-right animation-duration-1">
        ...
        <p>Gunakan akun SSO anda untuk mengakses <br>Sistem e-SOP Kementerian Sekretariat Negara.</p>
      ...
      <?php unset($_SESSION['message']); endif; ?>
        ...
        <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" />
          <div class="form-group">
            <input type="text" class="form-control" id="username" name="username" placeholder="NIP SSO" autocomplete="off" autofocus required>
          </div>
          <div class="form-group">
            <input type="password" class="form-control" id="password_user" name="password_user" placeholder="Password SSO" autocomplete="off" required>
			
          </div>
          
          <button class="btn btn-primary btn-block">Sign in</button>
        </form>
          <p align="center">© 2017 Kementerian Sekretariat Negara</p>
        </footer>
      </div>
    </div>
  </div>
