...
<div class="page">
  <div class="page-header">
    ...
    <div class="page-header-actions">
		  <a type="button" class="btn btn-success" href="<?= site_url('front/add_tentangkami')?>">
...
<script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#Tabel').DataTable({ 
       ...
       info: false,
         ajax:{
            url: "<?php echo site_url('front/get_tentang_kami')?>",
            type: "POST",
            data: function(d){
               return $.extend({},d,{
      ...
      $(document).on('click', 'a#btn-hapus', function(e){
         ...
         if(confirm('Apakah anda yakin ingin menghapus data ini ?')){
            ...
            $.ajax({
               url: '<?= site_url('front/delete_tentangkami'); ?>',
               type: 'POST',
               dataType: 'json',
               data:{
                  '<?= $this->security->get_csrf_token_name(); ?>': token_csrf(),
