<div class="page">
	<div class="page-header">
      ...
      <div class="page-header-actions">
		<a type="button" class="btn btn-warning" href="<?= site_url('front/tentang_kami')?>">
      	...
      	<div class="col-lg-12">
      		<div class="panel">
				...
				<div class="panel-body">
					...
					<br>
					<div id="pesan"></div>
					<?php if($title == 'Add Tentang Kami'): ?>
				  		<form class="form-horizontal" id="FrmAjax" method="post" action="<?= site_url('front/insert_tentangkami') ?>">
				  	...
				  	<?php elseif($title == 'Edit Tentang Kami'): ?>
      		...
      		$.ajax({ 
				...
				success: function(response){
					if(response.success == true){
						location.href = '<?= site_url('front/tentang_kami'); ?>';
					}else{
