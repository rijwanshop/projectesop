...
<style type="text/css">
   ...
   #Tabel th, #Tabel td:nth-child(5), #Tabel td:nth-child(6), #Tabel td:nth-child(7), #Tabel td:nth-child(8){
      text-align: center;
   }
</style>
<div class="page">
   <div class="page-header">
      ...
      <div class="page-header-actions">
         <a type="button" class="btn btn-success" href="<?= site_url('pengolahan_sop/pembuatan_sop') ?>">
   ...
   $(document).ready(function(){ 
      ...
      function token_csrf(){
       ...
       $('#Tabel').DataTable({ 
         ...
         order: [],
         ajax:{
            url: "<?php echo site_url('pengolahan_sop/get_data_sop')?>",
            type: "POST",
            data: function(d){
               return $.extend({},d,{
