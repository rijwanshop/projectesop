...
<div class="page">
	<div class="page-header">
      ...
      <div class="page-header-actions">
		<a type="button" class="btn btn-success" href="<?= site_url('master/add_pertanyaan')?>">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('#Tabel').DataTable({ 
       ...
       info: false,
         ajax:{
            url: "<?php echo site_url('master/get_data_pertanyaan')?>",
            type: "POST",
            data: function(d){
               return $.extend({},d,{
      ...
      columnDefs: [
       ...
       $(document).on('click', 'a#btn-hapus', function(e){
         ...
         if(confirm('Apakah anda yakin ingin menghapus data ini ?')){
            ...
            $.ajax({
               url: '<?= site_url('master/hapus_pertanyaan'); ?>',
               type: 'POST',
               dataType: 'json',
               data:{
                  '<?= $this->security->get_csrf_token_name(); ?>': token_csrf(),
