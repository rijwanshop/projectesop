	...
	<div class="page" style="max-width: 1300px;">
		<div class="page-header">
      		...
      		<div class="page-header-actions">
				<a type="button" class="btn btn-warning" href="<?= site_url('sop_lama'); ?>">
                            	...
                            	<div class="tab-content">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12" style="text-align: right;">
                                            ...
                                            &nbsp;
                                            <a href="<?= site_url('sop_lama'); ?>" class="btn btn-info">
	...
	$(document).ready(function(){ 
		...
		$('#FrmHeader').submit(function(e){
			...
			if($('#method').val() == 'insert')
				var url_link = '<?= site_url('sop_lama/insert_header_sop'); ?>';
			else
		...
		$('#FrmKegiatan').submit(function(e){
			...
			if($('#id_kegiatan').val() != ''){
				...
				alert('anda belum mengisi Header SOP');
			}
		});
